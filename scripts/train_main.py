...
Main training script for GeoCLIP model with command-line interface.
Supports training with various hyperparameters and automatic checkpointing.

Usage:
    python scripts/train_main.py --epochs 50 --batch_size 128 --lr 0.001
...
from geoclip_og.train import dataloader, train_decoder
from geoclip_og.model import GeoCLIP
...
def main(args):
    ...
    """
    print("🚀 Starting GeoCLIP training...")
