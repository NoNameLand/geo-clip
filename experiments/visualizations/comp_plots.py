...
import geoclip_og  # geoclip_og.LocationEncoder()
...
geo_tr  = GeoDictMixer(geoclip_og.LocationEncoder(), soft_tr, K=dict_K, temperature=0.7).to(device)
...
geo_un  = GeoDictMixer(geoclip_og.LocationEncoder(), soft_un, K=dict_K, temperature=0.7).to(device)
geo_un.eval()
